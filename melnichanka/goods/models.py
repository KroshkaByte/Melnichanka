...
from .constants import (BRANDS, FLOUR_NAME, GROUP_QUANTITY, PACKAGE,
                        PALLET_WEIGHT)
...
class Goods(models.Model):
    ...
    brand = models.CharField(
        max_length=100, choices=BRANDS, verbose_name="Брэнд", blank=True
    )
    package = models.IntegerField(choices=PACKAGE, verbose_name="Тара")
    group_quantity = models.PositiveIntegerField(
        choices=GROUP_QUANTITY, verbose_name="Количество штук в упаковке"
    )
