    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number_work', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None, verbose_name='Личный телефон')),
                ('phone_number_personal', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None, verbose_name='Рабочий телефон')),
