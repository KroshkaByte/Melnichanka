...
urlpatterns = [
    ...
    path("auto/delete/", views.AutoDeleteRequisitesView.as_view(), name="auto_delete"),
    ...
    path(
        "auto/req/delete/",
        views.AutoDeleteRequisitesView.as_view(),
        name="auto_delete_requisites",
    ),
    ...
    path(
        "rw/req/delete/", views.rw_delete_requisites_view, name="rw_delete_requisites"
    ),
]
