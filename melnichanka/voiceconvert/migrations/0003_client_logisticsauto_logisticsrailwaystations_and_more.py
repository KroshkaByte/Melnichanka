...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='factory',
            name='factory_name',
            field=models.CharField(choices=[('ККХП', 'АО "Курский Комбинат Хлебопродуктов'), ('КХПС', 'АО "Комбинат Хлебопродуктов Старооскольский'), ('ГКХП', 'АО "Городищенский Комбинат Хлебопродуктов')], default='ККХП', max_length=4),
        ),
